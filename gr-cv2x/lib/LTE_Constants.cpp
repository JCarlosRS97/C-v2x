...
static const int Size_PSXCH_symbloc_perSubframe = 10;
static constexpr int PSXCH_symbloc_perSubframe[] = {0, 1, 3, 4, 6, 7, 9, 10, 12, 13}; // PSSCH Symbol locations per subframe for PSCCH
