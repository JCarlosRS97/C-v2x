...
# Title: Top Block
# Generated: Wed Apr  3 17:42:12 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_head_0 = blocks.head(gr.sizeof_gr_complex*72, 10000)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*72, '/home/carlos/Escritorio/memuero.dat', False)
        ...
        self.connect((self.cv2x_extract_subcarriers_vcvc_0, 0), (self.blocks_head_0, 0))    
